...
void subpnt(LL x, LL y, bool flag = false){
    ...
    else if(ret == 5) color_text(7);
    else if(ret == 6) color_text(9);
    else if(ret == 7) color_text(1);
...
void pnt(LL x = 0, LL y = 0){
    if(x == 0 && y == 0){
        ...
        rep(i, 1, n){
            printf("%02lld | ", i);
            rep(j, 1, m){
                if(st[i][j] == 0) color_text(13), printf(".");
                else if(st[i][j] == 1) subpnt(i, j, true);
                else if(st[i][j] == 2) color_text(1), printf("M");
                printf("  ");
                color_text(0);
            }
            puts("");
